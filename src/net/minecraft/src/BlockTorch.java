...
public class BlockTorch extends Block {
    ...
    /**
     * Tests if the block can remain at its current location and will drop as an item if it is unable to stay. Returns True if it can stay and False if it drops. Args: world, x, y, z
     */
