...
public class CipherOutputStream extends FilterOutputStream {
    ...
    public void write(int par1ArrayOfByte) throws IOException {
        field_74848_c[0] = (byte) par1ArrayOfByte;
        ...
        if (field_74849_a != null) {
            ...
            out.write(field_74847_b.func_74851_a((byte) par1ArrayOfByte));
        }
    }
    ...
    public void write(byte par1ArrayOfByte[], int par2, int par3) throws IOException {
        if (field_74849_a != null) {
            ...
            int i = field_74849_a.func_71791_a(par1ArrayOfByte, par2, par3, abyte0, 0);
            ...
            field_74847_b.func_74850_a(par1ArrayOfByte, par2, par3, abyte1, 0);
