...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
    ...
    private static final String field_74825_e[] = {"AES", "ARC4", "Blowfish", "Camellia", "CAST5", "CAST6", "DES", "DESede", "GOST28147", "Grainv1", "Grain128", "HC128", "HC256", "IDEA", "Noekeon", "RC2", "RC5", "RC6", "Rijndael", "Salsa20", "SEED", "Serpent", "Skipjack", "TEA", "Twofish", "VMPC", "VMPCKSA3", "XTEA"};
    private static final String field_74822_f[] = {"X509"};
    private static final String field_74823_g[] = {"DSA", "DH", "EC", "RSA", "GOST", "ECGOST", "ElGamal"};
    private static final String field_74829_h[] = {"GOST3411", "MD2", "MD4", "MD5", "SHA1", "RIPEMD128", "RIPEMD160", "RIPEMD256", "RIPEMD320", "SHA224", "SHA256", "SHA384", "SHA512", "Tiger", "Whirlpool"};
